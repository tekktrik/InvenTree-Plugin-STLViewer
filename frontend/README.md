# STL Viewer- Frontend Code

This directory contains the frontend code for the STL Viewer plugin.
...
This will compile the frontend into the `../stl_viewer/static` directory (ready for distribution).
